...
ZONE_EDGE_GAP_M = 0.05
SOURCE_RIGHT_X = SOURCE_ZONE_CENTER_LOCAL_M[0] + SOURCE_ZONE_SIZE_M[0] / 2
PLACEMENT_ZONE_CENTER_X = (
    SOURCE_RIGHT_X + ZONE_EDGE_GAP_M + PLACEMENT_ZONE_SIZE_M[0] / 2
)
PLACEMENT_ZONE_CENTER_LOCAL_M = (PLACEMENT_ZONE_CENTER_X, 0.0, 0.0005)
assert abs(
    (PLACEMENT_ZONE_CENTER_LOCAL_M[0] - PLACEMENT_ZONE_SIZE_M[0] / 2)
    - (SOURCE_ZONE_CENTER_LOCAL_M[0] + SOURCE_ZONE_SIZE_M[0] / 2)
    - ZONE_EDGE_GAP_M
) < 1e-12
